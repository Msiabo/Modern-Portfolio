  ...
  emailjs
    ...
    .then(
      ...
      (error) => {
        toast({
          title: "Error",
          description: error.text || "Failed to send. Try again later.",
        });
        setIsSubmitting(false);
      }
    );
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:mhlongoquincy@gmail.com"
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/msiaboeldios/" target="_blank">
                  <Instagram />
                </a>
                <a
                  href="https://www.facebook.com/profile.php?id=61576312256335"
                  target="_blank"
                >
                  <FacebookIcon />
                </a>
